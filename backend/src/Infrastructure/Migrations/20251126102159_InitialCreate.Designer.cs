...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251126102159_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.LayerRegion", b =>
                {
                    ...
                    b.HasIndex("GeometryId")
                        .HasDatabaseName("ix_layer_regions_geometry_id");
            ...
            modelBuilder.Entity("Domain.Entities.LayerRegion", b =>
                {
                    b.HasOne("Domain.Entities.RegionGeometry", "Geometry")
                        .WithMany()
                        .HasForeignKey("GeometryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_layer_regions_region_geometries_geometry_id");
