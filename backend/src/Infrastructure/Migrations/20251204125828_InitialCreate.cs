        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_analytics = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "layer_region_styles",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    stroke = table.Column<bool>(type: "boolean", nullable: true),
                    color = table.Column<string>(type: "text", nullable: true),
                    weight = table.Column<int>(type: "integer", nullable: true),
                    opacity = table.Column<double>(type: "double precision", nullable: true),
                    line_cap = table.Column<string>(type: "text", nullable: true),
                    line_join = table.Column<string>(type: "text", nullable: true),
                    dash_array = table.Column<string>(type: "text", nullable: true),
                    dash_offset = table.Column<string>(type: "text", nullable: true),
                    fill = table.Column<bool>(type: "boolean", nullable: true),
                    fill_color = table.Column<string>(type: "text", nullable: true),
                    fill_opacity = table.Column<double>(type: "double precision", nullable: true),
                    fill_rule = table.Column<string>(type: "text", nullable: true),
                    class_name = table.Column<string>(type: "text", nullable: true),
                    region_id = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_layer_region_styles", x => x.id);
                    table.ForeignKey(
                        name: "fk_layer_region_styles_layer_regions_region_id",
                        column: x => x.region_id,
                        principalTable: "layer_regions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_layer_region_styles_region_id",
                table: "layer_region_styles",
                column: "region_id",
                unique: true);
